...
(cl:defmethod cur_x-val ((m <msgRosIotFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_ros_iot_bridge-msg:cur_x-val is deprecated.  Use pkg_ros_iot_bridge-msg:cur_x instead.")
  (cur_x m))

(cl:ensure-generic-function 'cur_y-val :lambda-list '(m))
(cl:defmethod cur_y-val ((m <msgRosIotFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_ros_iot_bridge-msg:cur_y-val is deprecated.  Use pkg_ros_iot_bridge-msg:cur_y instead.")
  (cur_y m))

(cl:ensure-generic-function 'cur_theta-val :lambda-list '(m))
(cl:defmethod cur_theta-val ((m <msgRosIotFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_ros_iot_bridge-msg:cur_theta-val is deprecated.  Use pkg_ros_iot_bridge-msg:cur_theta instead.")
  (cur_theta m))
